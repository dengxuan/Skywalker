...
namespace Skywalker.Extensions.Specifications;
...
public static class ExpressionFuncExtender
{
    ...
    /// <summary>
    /// Combines two given expressions by using the AND semantics if the condition is true.
    /// </summary>
    /// <typeparam name="T">The type of the object.</typeparam>
    /// <param name="first">The first part of the expression.</param>
    /// <param name="condition">The combine condition.</param>
    /// <param name="second">The second part of the expression.</param>
    /// <returns>The combined expression.</returns>
    ...
    /// <summary>
    /// Combines two given expressions by using the OR semantics if the condition is true.
    /// </summary>
    /// <typeparam name="T">The type of the object.</typeparam>
    /// <param name="first">The first part of the expression.</param>
    /// <param name="condition">The combine condition.</param>
    ...
    {
        return condition ? first.Or(second) : first;
    }
}
