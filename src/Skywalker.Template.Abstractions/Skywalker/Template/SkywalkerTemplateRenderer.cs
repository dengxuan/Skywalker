...
public class SkywalkerTemplateRenderer : ITemplateRenderer
{
    ...
    public SkywalkerTemplateRenderer(IServiceScopeFactory serviceScopeFactory, ITemplateDefinitionManager templateDefinitionManager, IOptions<SkywalkerTextTemplatingOptions> options)
    {
    ...
    public virtual async Task<string> RenderAsync(string templateName, object? model = null, string? cultureName = null, Dictionary<string, object>? globalContext = null)
    {
        ...
        throw new ArgumentException("There is no rendering engine found with template name: " + templateName);
    }
}
