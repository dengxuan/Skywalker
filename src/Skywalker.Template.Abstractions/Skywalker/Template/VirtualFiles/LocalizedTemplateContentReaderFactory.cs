...
public class LocalizedTemplateContentReaderFactory : ILocalizedTemplateContentReaderFactory
{
        ...
        TemplateDefinition templateDefinition)
    {
        ...
        if (!fileInfo.Exists)
        {
            ...
            {
                throw new FileNotFoundException("Could not find a file/folder at the location: " + virtualPath);
            }
        ...
        if (fileInfo.IsDirectory)
        {
            ...
            var folderReader = new VirtualFolderLocalizedTemplateContentReader([".tpl", ".cshtml"]);
