...
namespace Skywalker.EntityFrameworkCore.DependencyInjection
{
    public static class DbContextOptionsFactory
    {
            ...
            where TDbContext : EntityFrameworkCoreDbContext<TDbContext>
        {
            ...
            var context = new SkywalkerEntityFrameworkCoreDbContextConfigurationContext<TDbContext>(
        ...
        private static void PreConfigure<TDbContext>(
            SkywalkerDbContextOptions options,
            SkywalkerEntityFrameworkCoreDbContextConfigurationContext<TDbContext> context)
            where TDbContext : EntityFrameworkCoreDbContext<TDbContext>
        {
            ...
            if (!preConfigureActions.IsNullOrEmpty())
            {
                ...
                {
                    ((Action<SkywalkerEntityFrameworkCoreDbContextConfigurationContext<TDbContext>>)preConfigureAction).Invoke(context);
                }
            }
        }
            ...
            where TDbContext : EntityFrameworkCoreDbContext<TDbContext>
        {
            ...
            {
                ((Action<SkywalkerEntityFrameworkCoreDbContextConfigurationContext<TDbContext>>)configureAction).Invoke(context);
            }
