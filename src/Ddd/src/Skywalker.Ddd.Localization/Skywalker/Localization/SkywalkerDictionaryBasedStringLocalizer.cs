...
{
    public class SkywalkerDictionaryBasedStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
    {
        ...
        public SkywalkerDictionaryBasedStringLocalizer(LocalizationResource resource, List<IStringLocalizer> baseLocalizers)
        {
            Resource = resource;
        ...
        public class CultureWrapperStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
        {
            ...
            private readonly SkywalkerDictionaryBasedStringLocalizer _innerLocalizer;
            ...
            public CultureWrapperStringLocalizer(string cultureName, SkywalkerDictionaryBasedStringLocalizer innerLocalizer)
            {
