...
{
    public abstract class SkywalkerDbContext<TDbContext> : DbContext, ISkywalkerEfCoreDbContext, ITransientDependency where TDbContext : DbContext
    {
        ...
        public ILogger<SkywalkerDbContext<TDbContext>> Logger { get; set; }
