...
namespace Skywalker.IdentityServer.AspNetCore.Hosting.FederatedSignOut
{
    ...
    {
        private const string _iframeHtml = "<iframe style='display:none' width='0' height='0' src='{0}'></iframe>";
        ...
        public AuthenticationRequestHandlerWrapper(IAuthenticationRequestHandler inner, IHttpContextAccessor httpContextAccessor)
        {
            ...
            using ILoggerFactory? factory = _context.RequestServices.GetService(typeof(ILoggerFactory)) as ILoggerFactory;
        ...
        private async Task RenderResponseAsync(string iframeUrl)
        {
            ...
            {
                var iframe = string.Format(_iframeHtml, iframeUrl);
