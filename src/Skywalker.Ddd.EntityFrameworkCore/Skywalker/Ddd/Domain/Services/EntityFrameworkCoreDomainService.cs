...
public class EntityFrameworkCoreDomainService<TEntity> : DomainService<TEntity>, IEntityFrameworkCoreDomainService<TEntity>
    where TEntity : class, IEntity
{
    ...
    public Task<IQueryable<TEntity>> GetQueryableAsync() => Task.FromResult(Repository.AsQueryable());
}
...
public class EntityFrameworkCoreDomainService<TEntity, TKey> : DomainService<TEntity, TKey>, IEntityFrameworkCoreDomainService<TEntity,TKey>
