...
using Skywalker.Aspects.DynamicProxy.Serialization;
...
namespace Skywalker.Aspects.DynamicProxy.Generators
{
    public class ClassProxyGenerator : BaseProxyGenerator
    {
        ...
        {
            var implementedInterfaces = GetTypeImplementerMapping(interfaces, out IEnumerable<ITypeContributor> contributors, namingScope);
