// Copyright 2004-2012 Hermit Project - http://www.Hermitproject.org/
// 
...
namespace Skywalker.Aspects.DynamicProxy.Serialization
{
    /// <summary>
    ...
    public class ProxyObjectReference : IObjectReference, ISerializable, IDeserializationCallback
    {
        ...
        {
            ProxyObjectReference.scope = scope ?? throw new ArgumentNullException("scope");
        }
