...
using Skywalker.Threading.Locking;
using System;
using System.Collections.Generic;
using System.Diagnostics;
using System.Reflection;

namespace Skywalker.Aspects.DynamicProxy.Internal
{
    public static class InvocationHelper
    {
        ...
        private static readonly Lock _locker = Lock.Create();
        ...
        public static MethodInfo GetMethodOnType(Type type, MethodInfo proxiedMethod)
        {
            ...
            using (var locker = _locker.ForReadingUpgradeable())
            {
        ...
        private static MethodInfo GetFromCache(MethodInfo methodInfo, Type type)
        {
            ...
            cache.TryGetValue(key, out MethodInfo method);
            return method;
        }
