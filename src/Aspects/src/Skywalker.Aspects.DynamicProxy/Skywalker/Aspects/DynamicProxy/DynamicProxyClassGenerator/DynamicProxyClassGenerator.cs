...
namespace Skywalker.Aspects.DynamicProxy
{
    ...
    public class DynamicProxyClassGenerator
    {
        ...
        {
            TypeToIntercept = Check.NotNull(typeToIntercept, nameof(typeToIntercept));
            Interceptors = Check.NotNull(interceptors, nameof(interceptors));
        ...
        public static DynamicProxyClassGenerator CreateInterfaceGenerator(Type @interface, InterceptorRegistry interceptors)
        {
            ...
            {
                throw new ArgumentException("The type to intercept must be an interface.", nameof(@interface));
            }
        ...
        public static DynamicProxyClassGenerator CreateVirtualMethodGenerator(Type type, InterceptorRegistry interceptors)
        {
            ...
            if (type.IsSealed)
            {
                throw new ArgumentException("The type to intercept must not be a sealed type.", nameof(type));
            }
