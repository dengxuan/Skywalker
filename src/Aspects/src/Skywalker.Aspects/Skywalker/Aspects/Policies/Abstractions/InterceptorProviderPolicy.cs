...
namespace Skywalker.Aspects.Policies
{
    ...
    public class InterceptorProviderPolicy
    {
        ...
        {
            InterceptorProviderType = Check.NotNull(interceptorProviderType, nameof(interceptorProviderType));
            InterceptorProviderFactory = Check.NotNull(interceptorProviderFactory, nameof(interceptorProviderFactory));
