...
namespace Skywalker.Extensions.VirtualFileSystem.Embedded
{
    public class SkywalkerEmbeddedFileProvider : DictionaryBasedFileProvider
    {
        ...
        public SkywalkerEmbeddedFileProvider([NotNull] Assembly assembly, [MaybeNull] string? baseNamespace = null)
        {
        ...
        private static void AddDirectoriesRecursively(Dictionary<string, IFileInfo> files, string directoryPath, DateTimeOffset lastModificationTime)
        {
            ...
            files[directoryPath] = new VirtualDirectoryFileInfo(directoryPath, CalculateFileName(directoryPath), lastModificationTime);
