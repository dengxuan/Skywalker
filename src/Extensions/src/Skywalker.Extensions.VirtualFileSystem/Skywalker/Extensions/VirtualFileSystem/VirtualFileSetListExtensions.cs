...
namespace Skywalker.Extensions.VirtualFileSystem
{
    ...
    {
        public static void AddEmbedded<T>([NotNull] this VirtualFileSetList list, [MaybeNull] string? baseNamespace = null, [MaybeNull] string? baseFolder = null)
        {
        ...
        private static IFileProvider CreateFileProvider([NotNull] Assembly assembly, [MaybeNull] string? baseNamespace = null, [MaybeNull] string? baseFolder = null)
        {
        ...
        public static void ReplaceEmbeddedByPhysical<T>([NotNull] this VirtualFileSetList fileSets, [NotNull] string physicalPath)
        {
