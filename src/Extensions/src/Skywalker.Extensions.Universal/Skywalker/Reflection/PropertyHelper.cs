...
namespace Skywalker.Reflection
{
    public class PropertyHelper
    {
        ...
        private static readonly MethodInfo _callNullSafePropertyGetterOpenGenericMethod =
            typeof(PropertyHelper).GetTypeInfo().GetDeclaredMethod(nameof(CallNullSafePropertyGetter))!;

        private static readonly MethodInfo _callNullSafePropertyGetterByReferenceOpenGenericMethod =
        ...
        private static readonly ConcurrentDictionary<Type, PropertyHelper[]> _propertiesCache =
            new ConcurrentDictionary<Type, PropertyHelper[]>();

        private static readonly ConcurrentDictionary<Type, PropertyHelper[]> _visiblePropertiesCache =
            new ConcurrentDictionary<Type, PropertyHelper[]>();
        ...
        // 'ref struct' types.
        private static readonly Type? _isByRefLikeAttribute = Type.GetType("System.Runtime.CompilerServices.IsByRefLikeAttribute", throwOnError: false);
        ...
        {
            return GetProperties(type, p => CreateInstance(p), _propertiesCache);
        }
        ...
        {
            return GetVisibleProperties(typeInfo.AsType(), p => CreateInstance(p), _propertiesCache, _visiblePropertiesCache);
        }
        ...
        {
            return GetVisibleProperties(type, p => CreateInstance(p), _propertiesCache, _visiblePropertiesCache);
        }
        ...
        public static Func<object, object> MakeFastPropertyGetter(PropertyInfo propertyInfo)
        {
            ...
            return MakeFastPropertyGetter(
                propertyInfo,
                _callPropertyGetterOpenGenericMethod,
        ...
        public static Func<object, object> MakeNullSafeFastPropertyGetter(PropertyInfo propertyInfo)
        {
            ...
            return MakeFastPropertyGetter(
                propertyInfo,
                _callNullSafePropertyGetterOpenGenericMethod,
                _callNullSafePropertyGetterByReferenceOpenGenericMethod);
        }
        ...
        public static Action<object, object> MakeFastPropertySetter(PropertyInfo propertyInfo)
        {
            ...
            var callPropertySetterClosedGenericMethod =
                _callPropertySetterOpenGenericMethod.MakeGenericMethod(typeInput, parameterType);
        ...
        {
            return
                _isByRefLikeAttribute != null &&
                property.PropertyType.IsValueType &&
                property.PropertyType.IsDefined(_isByRefLikeAttribute);
        }
    }
}
