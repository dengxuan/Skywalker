...
namespace Skywalker.Extensions.Linq.Parser
{
    ...
    public class ExpressionParser
    {
        ...
        public ExpressionParser([MaybeNull] ParameterExpression[] parameters, [NotNull] string expression, [MaybeNull] object[] values, [MaybeNull] ParsingConfig parsingConfig)
        {
        ...
        public Expression Parse([MaybeNull] Type resultType, bool createParameterCtor = true)
        {
