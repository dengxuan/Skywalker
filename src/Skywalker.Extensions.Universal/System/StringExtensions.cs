...
public static partial class StringExtensions
{
    ...
    private static string ToHash(this string str, HashAlgorithm algorithm, Encoding encoding)
    {
        ...
        var hashedBytes = bytes.ToHash(algorithm);
        return hashedBytes.ToHex();
    }

    private static bool VerifyHash(this string str, string hexHashedValue, HashAlgorithm algorithm, Encoding encoding)
    {
        var bytes = encoding.GetBytes(str);
        var hashedBytes = Convert.FromHexString(hexHashedValue);
...
#nullable enable
    ...
    public static bool VerifyMd5(this string str, string hexHashedValue)
    {
        return str.VerifyMd5(hexHashedValue, Encoding.Default);
    }

    public static bool VerifyMd5(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = MD5.Create();
        return str.VerifyHash(hexHashedValue, algorithm, encoding);
    }
    ...
    public static bool VerifySha1(this string str, string hexHashedValue)
    {
        return str.VerifySha1(hexHashedValue, Encoding.Default);
    }

    public static bool VerifySha1(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = SHA1.Create();
        return str.VerifyHash(hexHashedValue, algorithm, encoding);
    }
    ...
    public static bool VerifySha256(this string str, string hexHashedValue)
    {
        return str.VerifySha256(hexHashedValue, Encoding.Default);
    }

    public static bool VerifySha256(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = SHA256.Create();
        return str.VerifyHash(hexHashedValue, algorithm, encoding);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue)
    {
        return str.VerifyHmacSha256(hexHashedValue, Encoding.Default);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = HMAC.Create("HMACSHA256");
        return str.VerifyHash(hexHashedValue, algorithm!, encoding);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue, string key)
    {
        return str.VerifyHmacSha256(hexHashedValue, key, Encoding.Default);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue, byte[] key)
    {
        return str.VerifyHmacSha256(hexHashedValue, key, Encoding.Default);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue, string key, Encoding encoding)
    {
        return str.VerifyHmacSha256(hexHashedValue, encoding.GetBytes(key), encoding);
    }

    public static bool VerifyHmacSha256(this string str, string hexHashedValue, byte[] key, Encoding encoding)
    {
    ...
    public static bool VerifySha384(this string str, string hexHashedValue)
    {
        return str.VerifySha384(hexHashedValue, Encoding.Default);
    }

    public static bool VerifySha384(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = SHA384.Create();
        return str.VerifyHash(hexHashedValue, algorithm, encoding);
    }
    ...
    public static bool VerifySha512(this string str, string hexHashedValue)
    {
        return str.VerifySha512(hexHashedValue, Encoding.Default);
    }

    public static bool VerifySha512(this string str, string hexHashedValue, Encoding encoding)
    {
        using var algorithm = SHA512.Create();
        return str.VerifyHash(hexHashedValue, algorithm, encoding);
    }
    ...
    public static string ToHmacSha256(this string str, string key)
    {
        return str.ToHmacSha256(key, Encoding.Default);
    }

    public static string ToHmacSha256(this string str, string key, Encoding encoding)
    {
        using var algorithm = new HMACSHA256(encoding.GetBytes(key));
        return str.ToHash(algorithm!, encoding);
    }
