...
public class JiguangProxySupplier : IProxySupplier
{
    private readonly ProxyOptions _options;
    private readonly IHttpClientFactory _httpClientFactory;

    public JiguangProxySupplier(IOptions<ProxyOptions> proxyOptions, IHttpClientFactory httpClientFactory)
    {
    ...
    public async Task<IEnumerable<ProxyEntry>> GetProxiesAsync()
    {
        ...
        var apiAddress = _options.ApiAddresses?["Jiguang"];
