...
namespace Skywalker.Ddd.AspNetCore.Mvc;
...
public class ResponseWrapperOptions
{
    ...
    public WrapResultAttribute DefaultWrapResultAttribute { get; } = new WrapResultAttribute();
    ...
    /// Default: true.
    /// </summary>
    public bool SetNoCacheForAjaxResponses { get; set; } = true;
}
