...
//public class HttpCryptoStream : Stream, IDisposable
//{
//    // Member variables
...
//    public HttpCryptoStream(Stream stream, ICryptoTransform transform, CryptoStreamMode mode)
//        : this(stream, transform, mode, false)
//    {
//    }

//    public HttpCryptoStream(Stream stream, ICryptoTransform transform, CryptoStreamMode mode, bool leaveOpen)
//    {
...
//                if (!_stream.CanRead)
//                {
//                    throw new ArgumentException("Stream was not readable.", nameof(stream));
//                }
//                _canRead = true;
//                break;
...
//                if (!_stream.CanWrite)
//                {
//                    throw new ArgumentException("Stream was not writable.", nameof(stream));
//                }
//                _canWrite = true;
//                break;
...
//        if (_stream is HttpCryptoStream innerCryptoStream)
//        {
...
//        if (GetType() != typeof(HttpCryptoStream))
...
//    {
//        if (!CanRead)
//            return ValueTask.FromException<int>(new NotSupportedException("Stream does not support reading."));
...
//    {
//        if (!CanWrite)
//            return ValueTask.FromException(new NotSupportedException("Stream does not support writing."));
