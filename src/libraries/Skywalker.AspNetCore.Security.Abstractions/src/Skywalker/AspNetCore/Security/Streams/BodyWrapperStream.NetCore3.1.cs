...
//namespace Skywalker.AspNetCore.Security.Streams;
//#if NETCOREAPP3_1
///// <summary>
///// Stream wrapper that create specific encryption stream only if necessary.
///// </summary>
//internal class BodyWrapperStream : Stream, IHttpResponseBodyFeature
//{
//    private readonly HttpContext? _context;
//    private readonly Stream? _bodyOriginalStream;
//    private readonly IResponseEncrpytionProvider? _provider;
//    private readonly IHttpResponseBodyFeature? _innerBufferFeature;
//    private readonly IHttpResponseBodyFeature? _innerSendFileFeature;
...
//    internal BodyWrapperStream(HttpContext? context, Stream? bodyOriginalStream, IResponseEncrpytionProvider? provider, IHttpResponseBodyFeature? innerBufferFeature, IHttpResponseBodyFeature? innerSendFileFeature)
//    {
//        _context = context;
...
//    public Stream Stream => _bodyOriginalStream;
...
//            _autoFlush = true;
//        }
//        _innerBufferFeature?.DisableBuffering();
//    }
