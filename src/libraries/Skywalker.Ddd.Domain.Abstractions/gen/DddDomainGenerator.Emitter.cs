...
public partial class DddDomainGenerator
{
    internal class Emitter
    {
        ...
        public static void Emit(GeneratorExecutionContext context, IReadOnlyList<DomainServiceClass> domainServiceClasses)
        {
            ...
            var file = @"Templates/DddDomain.sbn-cs";
            var template = Template.Parse(EmbeddedResource.GetContent(file), file);
            var output = template.Render(new { GeneratorVersion = generatorVersion, DomainServiceClasses = domainServiceClasses }, member => member.Name);
            context.AddSource("Skywalker.Ddd.DomainServices.g.cs", SourceText.From(output, Encoding.UTF8));
