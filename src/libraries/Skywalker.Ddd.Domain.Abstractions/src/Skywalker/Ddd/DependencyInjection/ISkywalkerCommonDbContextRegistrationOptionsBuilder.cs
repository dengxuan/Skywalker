...
namespace Skywalker.DependencyInjection
{
    public interface ISkywalkerCommonDbContextRegistrationOptionsBuilder
    {
        ...
        /// <returns></returns>
        ISkywalkerCommonDbContextRegistrationOptionsBuilder SetDefaultRepositoryClasses(Type repositoryImplementationType, Type repositoryImplementationTypeWithoutKey);
    }
}