...
public class SkywalkerAsyncTimer
{
    ...
    /// </summary>
    public Func<SkywalkerAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
    ...
    public ILogger<SkywalkerAsyncTimer> Logger { get; set; }
    ...
    public SkywalkerAsyncTimer(ILogger<SkywalkerAsyncTimer> logger, IExceptionNotifier exceptionNotifier)
    {
    ...
    public void Start(CancellationToken cancellationToken = default)
    {
        if (Period <= 0)
        {
            throw new SkywalkerException("Period should be set before starting the timer!");
        }
