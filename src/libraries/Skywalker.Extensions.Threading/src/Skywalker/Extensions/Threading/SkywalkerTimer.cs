...
//        public ILogger<SkywalkerTimer> Logger { get; set; }
...
//        public SkywalkerTimer()
//        {
//            ExceptionNotifier = NullExceptionNotifier.Instance;
//            Logger = NullLogger<SkywalkerTimer>.Instance;
...
//                while (_performingTasks && cancellationToken.IsCancellationRequested)
//                {
