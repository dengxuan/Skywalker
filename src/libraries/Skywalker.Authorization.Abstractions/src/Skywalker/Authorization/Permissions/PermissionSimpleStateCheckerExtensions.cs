...
public static class PermissionSimpleStateCheckerExtensions
{
    ...
    public static TState RequirePermissions<TState>(this TState state, params string[] permissions)
        where TState : IHasSimpleStateCheckers<TState>
    {
    ...
    public static TState RequirePermissions<TState>(this TState state, bool requiresAll, params string[] permissions)
        where TState : IHasSimpleStateCheckers<TState>
    {
    ...
    public static TState RequirePermissions<TState>(this TState state, bool requiresAll, bool batchCheck, params string[] permissions)
        where TState : IHasSimpleStateCheckers<TState>
    {
