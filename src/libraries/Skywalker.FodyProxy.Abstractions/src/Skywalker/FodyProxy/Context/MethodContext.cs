...
namespace Skywalker.FodyProxy.Context;
...
public sealed class MethodContext
{
    ...
    /// <summary>
    /// Method return value, if you want to assign a value to it, you'd better use <see cref="HandledException(IInterceptor, object)"/> or <see cref="ReplaceReturnValue(IInterceptor, object)"/>
    /// </summary>
    ...
    /// <summary>
    /// when multiple <see cref="IInterceptor"/> applied to the method, you will know who replace the return value
    /// </summary>
    public IInterceptor? ReturnValueModifier { get; private set; }

    /// <summary>
    /// Exception throws by method, if you want to prevent exception, you'd better use <see cref="HandledException(IInterceptor, object)"/>
    /// </summary>
    ...
    /// <summary>
    /// when multiple <see cref="IInterceptor"/> applied to the method, you will know who handled the exception
    /// </summary>
    public IInterceptor? ExceptionHandler { get; private set; }
    ...
    /// </summary>
    public void HandledException(IInterceptor handler, object returnValue)
    {
    ...
    /// </summary>
    public void ReplaceReturnValue(IInterceptor modifier, object returnValue)
    {
        if (HasReturnValue)
        {
