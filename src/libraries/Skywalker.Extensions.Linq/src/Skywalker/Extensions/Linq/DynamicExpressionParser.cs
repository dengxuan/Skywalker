...
namespace Skywalker.Extensions.Linq
{
    ...
    public static class DynamicExpressionParser
    {
        ...
        public static LambdaExpression ParseLambda(ParsingConfig? parsingConfig, bool createParameterCtor, Type resultType, string expression, params object[] values)
        {
            ...
            var parser = new ExpressionParser(Array.Empty<ParameterExpression>(), expression, values, parsingConfig);
        ...
        //[PublicAPI]
        //public static LambdaExpression ParseLambda(Type delegateType, Type resultType, string expression, params object[] values)
        //{
