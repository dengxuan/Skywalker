...
namespace Skywalker.Extensions.Linq
{
    ...
    public static class DynamicClassFactory
    {
        ...
        private static readonly CustomAttributeBuilder CompilerGeneratedAttributeBuilder = new(typeof(CompilerGeneratedAttribute).GetConstructor(EmptyTypes), Array.Empty<object>());
        ...
        private static readonly CustomAttributeBuilder DebuggerHiddenAttributeBuilder = new(typeof(DebuggerHiddenAttribute).GetConstructor(EmptyTypes), Array.Empty<object>());
        ...
        private static string DynamicAssemblyName = "Skywalker.Extensions.Linq.DynamicClasses, Version=1.0.0.0";
        private static string DynamicModuleName = "Skywalker.Extensions.Linq.DynamicClasses";
