...
namespace Skywalker.Extensions.Tokenizer;
...
public static class Tokener
{
    ...
    public static IEnumerable<Token> Tokenize(string input)
    {
        ...
        while (reader.Read() != null)
        {
            ...
            if (ch == '-' || IsNmStart(ch))
            {
                ...
                yield return reader.Value == '(' ? Token.Function(reader.Marked()) : Token.Ident(reader.MarkedWithUnread());
            }
            //
            // Integer
            //
    ...
    private sealed class Reader
    {
        ...
        public char? Value => Ready ? _input[_index] : null;
