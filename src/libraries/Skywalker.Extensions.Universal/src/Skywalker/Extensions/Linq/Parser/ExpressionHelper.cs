...
internal class ExpressionHelper : IExpressionHelper
{
    ...
    {
        return ExpressionHelper.GenerateStaticMethodCall("Concat", left, right);
    }
    ...
    public Expression GenerateGreaterThan(Expression left, Expression right)
    {
        ...
        {
            return Expression.GreaterThan(ExpressionHelper.GenerateStaticMethodCall("Compare", left, right), Expression.Constant(0));
        }
    ...
    public Expression GenerateGreaterThanEqual(Expression left, Expression right)
    {
        if (left.Type == typeof(string))
        {
            return Expression.GreaterThanOrEqual(ExpressionHelper.GenerateStaticMethodCall("Compare", left, right), Expression.Constant(0));
        }
    ...
    public Expression GenerateLessThan(Expression left, Expression right)
    {
        if (left.Type == typeof(string))
        {
            return Expression.LessThan(ExpressionHelper.GenerateStaticMethodCall("Compare", left, right), Expression.Constant(0));
        }
    ...
    public Expression GenerateLessThanEqual(Expression left, Expression right)
    {
        if (left.Type == typeof(string))
        {
            return Expression.LessThanOrEqual(ExpressionHelper.GenerateStaticMethodCall("Compare", left, right), Expression.Constant(0));
        }
    ...
    public bool TryGenerateAndAlsoNotNullExpression(Expression sourceExpression, bool addSelf, out Expression generatedExpression)
    {
        ...
        var binaryExpressions = expressions.Where(expression => TypeHelper.TypeMaybeNull(expression.Type))
