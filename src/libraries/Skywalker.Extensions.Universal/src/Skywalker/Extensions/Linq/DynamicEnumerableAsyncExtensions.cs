...
public static class DynamicEnumerableAsyncExtensions
{
    ...
    public static Task<dynamic[]> ToDynamicArrayAsync(this IEnumerable source, Type type)
    {
    ...
    /// <param name="source">A <see cref="IEnumerable"/> to create an array from.</param>
    /// <returns>An array that contains the elements from the input sequence.</returns>
    public static Task<dynamic[]> ToDynamicArrayAsync(this IEnumerable source)
    {
        Check.NotNull(source, nameof(source));
    ...
    public static Task<T[]> ToDynamicArrayAsync<T>(this IEnumerable source)
    {
        Check.NotNull(source, nameof(source));
    ...
    public static Task<List<dynamic>> ToDynamicListAsync(this IEnumerable source, Type type)
    {
        Check.NotNull(source, nameof(source));
        Check.NotNull(type, nameof(type));
    ...
    public static Task<List<dynamic>> ToDynamicListAsync(this IEnumerable source)
    {
        Check.NotNull(source, nameof(source));
    ...
    public static Task<List<T>> ToDynamicListAsync<T>(this IEnumerable source)
    {
        Check.NotNull(source, nameof(source));
