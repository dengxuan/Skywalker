...
namespace Skywalker.Extensions.DependencyInjection.Interceptors
{
    ...
    public sealed class InterceptorChainBuilder : IInterceptorChainBuilder
    {
        ...
        private bool TryGetTnterceptor(Type interceptorType, IServiceProvider services, InterceptDelegate next, out Interceptor interceptor)
        {
            ...
            lock (_locker)
            {
                ...
                var interceptorExpression = Expression.Parameter(typeof(object), "interceptor");
                var invocationContextExpression = Expression.Parameter(typeof(InvocationContext), "context");
                ...
                var instance = ActivatorUtilities.CreateInstance(services, interceptorType, new object[] { next });
        ...
        {
            interceptorType.NotNull(nameof(interceptorType));
        ...
        {
            interceptor.NotNull(nameof(interceptor));
