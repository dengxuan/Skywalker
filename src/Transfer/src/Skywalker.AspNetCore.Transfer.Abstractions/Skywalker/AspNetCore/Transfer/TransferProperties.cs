...
namespace Skywalker.AspNetCore.Transfer
{
    ...
    public class TransferProperties
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferProperties"/> class.
        /// </summary>
        ...
        [JsonConstructor]
        public TransferProperties(IDictionary<string, string?> items)
        ...
        public TransferProperties(IDictionary<string, string?>? items, IDictionary<string, object?>? parameters)
        {
        ...
        public TransferProperties Clone()
