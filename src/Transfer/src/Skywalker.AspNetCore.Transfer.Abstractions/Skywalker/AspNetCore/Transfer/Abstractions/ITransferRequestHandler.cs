...
namespace Skywalker.AspNetCore.Transfer.Abstractions
{
    ...
    /// </summary>
    public interface ITransferRequestHandler : ITransferHandler
    {
        /// <summary>
        ...
        /// which does not invoke any subsequent <see cref="ITransferHandler"/> or middleware configured in the request pipeline
